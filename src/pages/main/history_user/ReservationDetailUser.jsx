      ...
      <div className="information">
        <div>
          ...
          <div className="field">
            ...
            {console.log(dataUser.dateTime)}
            <span className="value">
              {format(new Date(dataUser.dateTime), "dd/MM/yyyy HH:mm")}
            </span>
          </div>
          <div className="field">
          ...
          <div className="field">
            ...
            <span className="value">
              {dataUser.table ? dataUser?.table.name : "TBD"}
            </span>
          </div>
          <div className="field">
          ...
          <div className="field">
            ...
            <span className="value">{tagColor(dataUser.status)}</span>
          </div>
        </div>
      </div>
      <button
        className="button-back"
        onClick={() => setOpenDetailComponent(false)}
      >
        Go back
      </button>
    </div>
